...
async def create_short_url(
    ...
    Request/response validation is handled entirely by the URLRequestSchema /
    URLResponseSchema Pydantic models — by the time url_in reaches this
